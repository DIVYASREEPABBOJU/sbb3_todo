...
public class Register {
	// to encapsulate declare vars as private
	private int regid;
	...
	public Register(int regid,String fname,String lname,String email,String pass,
			long mobile, String address) {
		// assign constructor parameters to class instance variables
		this.regid=regid;
		this.fname=fname;
		this.lname=lname;
		this.email=email;
